  ...
  return (
    <div className="flex min-h-screen bg-[#050505] flex-col lg:flex-row">
      ...
      <div className="w-full lg:w-[45%] flex flex-col justify-center px-8 sm:px-16 xl:px-24 z-20 relative bg-[#050505] shadow-[20px_0_50px_rgba(0,0,0,0.6)]">
        ...
        >
          {/* Logo (Desktop Only) */}
          <Link href="/" className="hidden lg:block mb-16">
          ...
          <div className="space-y-2 mb-10">
            ...
            <p className="text-gray-400 text-sm font-medium">Sign in to continue your cinematic journey</p>
          </div>
          ...
          <div className="mt-8 text-center sm:text-left">
            <p className="text-gray-500 text-sm font-medium">
              New to StreamFlix?{" "}
              <Link href="/signup" className="text-white hover:text-gray-200 font-bold transition-colors underline-offset-4 hover:underline">
                Sign up
              </Link>
            </p>
          </div>
